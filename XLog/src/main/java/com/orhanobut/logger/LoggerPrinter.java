...
class LoggerPrinter implements com.orhanobut.logger.Printer {
  ...
  private final List<com.orhanobut.logger.LogAdapter> logAdapters = new ArrayList<>();
  ...
  @Override public void d(@Nullable Object object) {
    log(DEBUG, null, com.orhanobut.logger.Utils.toString(object));
  }
  ...
  @Override public void json(@Nullable String json) {
    if (com.orhanobut.logger.Utils.isEmpty(json)) {
  ...
  @Override public void xml(@Nullable String xml) {
    if (com.orhanobut.logger.Utils.isEmpty(xml)) {
  ...
  @Override public synchronized void log(int priority,
    ...
    if (throwable != null && message != null) {
      message += " : " + com.orhanobut.logger.Utils.getStackTraceString(throwable);
    }
    if (throwable != null && message == null) {
      message = com.orhanobut.logger.Utils.getStackTraceString(throwable);
    }
    if (com.orhanobut.logger.Utils.isEmpty(message)) {
      message = "Empty/NULL log message";
    }

    for (com.orhanobut.logger.LogAdapter adapter : logAdapters) {
